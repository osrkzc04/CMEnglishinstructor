...
async function main() {
  ...
  if (existingApplications === 0) {
    ...
    const applications: Array<{
      ...
      },
      {
        ...
        reviewed: {
          reviewedAt: day(20),
          rejectionReason: "La disponibilidad ofrecida no coincide con la demanda actual.",
        },
      },
    ]
  ...
  const students: Array<{
  ...
  }> = [
    {
      ...
      position: "Subgerente de Riesgos",
      notes: "Necesita inglés conversacional para reuniones internacionales.",
      createdAt: dayAgo(75),
      schedule: [
        { dayOfWeek: 2, startTime: "07:00", endTime: "08:30" },
        { dayOfWeek: 4, startTime: "07:00", endTime: "08:30" },
      ],
    },
    {
      ...
      notes: "Requiere foco en negociación y presentaciones.",
      createdAt: dayAgo(60),
      schedule: [
    ...
    {
      email: "valeria.quispe@example.com",
      firstName: "Valeria",
      lastName: "Quispe",
      document: "1722334413",
      phone: "+593997776655",
    ...
    },
    {
      ...
      phone: "+593983221100",
      status: UserStatus.ACTIVE,
      notes: "Estudiante adolescente preparándose para examen Cambridge B1.",
      createdAt: dayAgo(30),
      schedule: [
    ...
    },
    {
      ...
      phone: "+593990112233",
      status: UserStatus.ACTIVE,
      company: "Marathon Sports",
      position: "Coordinadora de Marketing",
      createdAt: dayAgo(22),
      schedule: [{ dayOfWeek: 6, startTime: "09:00", endTime: "11:00" }],
    },
    {
      ...
      notes: "Pendiente de cargar resultado de prueba de ubicación.",
      createdAt: dayAgo(8),
      schedule: [
    ...
    },
    {
      ...
      status: UserStatus.PENDING_APPROVAL,
      createdAt: dayAgo(3),
      schedule: [{ dayOfWeek: 0, startTime: "10:00", endTime: "12:00" }],
    },
    {
      email: "fernando.guzman@example.com",
      firstName: "Fernando",
      lastName: "Guzmán",
      document: "1722334418",
      phone: "+593978332211",
      ...
      notes: "Pausado a pedido del estudiante por viaje. Reanudar en próximo trimestre.",
      createdAt: dayAgo(180),
      schedule: [],
    },
    {
      email: "isabel.delgado@example.com",
      firstName: "Isabel",
      lastName: "Delgado",
      document: "1722334419",
      phone: "+593985665544",
      status: UserStatus.ACTIVE,
      company: "Universidad San Francisco",
      position: "Docente Asociada",
      createdAt: dayAgo(95),
      schedule: [
