...
export function MarketingAbout() {
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute -right-16 top-1/2 -translate-y-1/2 select-none font-serif text-[420px] italic leading-none text-teal-500/[0.05] sm:text-[560px] lg:text-[680px]"
      >
        &amp;
      </span>
      ...
      <div className="relative mx-auto w-full max-w-[1180px] px-6">
        <div className="mx-auto max-w-[720px]">
          <Reveal as="header">
            ...
            <h2
              id="about-title"
              className="font-serif text-[36px] leading-[1.12] tracking-[-0.02em] text-foreground sm:text-[46px]"
            >
              Una escuela pequeña
              <em className="font-light italic text-text-2"> con vocación grande</em>.
            </h2>
          </Reveal>

          <Reveal delay={120}>
            <div className="mt-8 space-y-5 text-[17px] leading-[1.7] text-text-2">
              <p>
                <span className="font-medium text-foreground">
                  CM English Instructor
                </span>{" "}
                acompaña a personas y equipos a comunicarse con seguridad en
                inglés y español. Trabajamos con currículos publicados por
                editoriales reconocidas, docentes certificados y un
                acompañamiento cercano que prioriza el avance real del
                estudiante por sobre el ritmo del programa.
              </p>
              <p>
                Creemos que aprender un idioma con seriedad no tiene que
                sentirse frío. Por eso combinamos rigor académico con una
                manera muy humana de enseñar — clases bien preparadas,
                retroalimentación oportuna y una relación directa con quien
                dirige la academia. Sin formularios eternos, sin call centers.
              </p>
              <p>
                Trabajamos con ejecutivos, equipos corporativos, adultos,
                adolescentes y niños. Cada plan se diseña a medida — virtual,
                presencial o híbrido — y se ajusta a la rutina real de quien
                aprende, no al revés.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={220}>
            <div className="mt-12 flex flex-col gap-1 border-t border-border pt-6">
              <p className="font-mono text-[11px] uppercase tracking-[0.12em] text-text-3">
                Dirige
              </p>
              <p className="font-serif text-[20px] italic leading-[1.3] text-foreground">
                Carolina Monsalve
              </p>
