...
import { listProgramLevelsForAdmin, listProgramOptions } from "@/modules/catalog/queries"
...
export default async function NivelesPage() {
  ...
  const [levels, programs] = await Promise.all([listProgramLevelsForAdmin(), listProgramOptions()])
    ...
    >
      <header className="mb-7 max-w-2xl">
        ...
        <p className="text-text-3 mt-2 text-[14px] leading-[1.55]">
          Cada nivel define las horas totales que se contratan al matricular un alumno y aparece en
          los selectores al crear aulas o matrículas. Desactivar un nivel lo esconde de los
          selectores sin perder las matrículas existentes.
        </p>
      </header>
