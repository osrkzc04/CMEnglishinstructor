    ...
    >
      <header className="mb-7 max-w-2xl">
        ...
        <p className="mt-2 text-[14px] leading-[1.55] text-text-3">
          Lo que tienes hoy, lo que viene en los próximos días y un resumen de
          las últimas semanas. Si la clase es virtual, vas a encontrar el
          enlace acá.
        </p>
      </header>
...
function SessionRow({
  ...
  const cardClass = [
    ...
    highlight === "today" && "border-teal-500/30 shadow-[0_1px_0_rgba(39,159,137,0.06),0_6px_18px_-12px_rgba(39,159,137,0.20)]",
